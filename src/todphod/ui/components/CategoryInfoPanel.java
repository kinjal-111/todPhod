...
public class CategoryInfoPanel extends javax.swing.JPanel {
    public static int WIDTH = 965;
    public static int HEIGHT = 50;
    
    private String categoryName, customerPhoneNo, customerEmail;
     ...
     */
    public CategoryInfoPanel(int id, String categoryName) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jlCategoryName);
        jlCategoryName.setBounds(20, 13, 730, 24);
        ...
        add(jSeparator4);
        jSeparator4.setBounds(770, 0, 2, 60);
